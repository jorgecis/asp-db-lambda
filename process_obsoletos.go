...
func process_cvs_obsoletos(filename string) (string, error) {

	var catalogs []Obsoletes
...
mainloop:
	...
	collection := db.Collection("obsoletes")
	...
	log.Printf("Obsoletos: insertados %d distribuidores en la colección 'obsoletes'", len(catalogs))
